...
const RevenueModal = ({ isOpen, onClose, onSuccess }: RevenueModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Receita salva com sucesso!', { id: toastId });
      setFormData({
        description: '',
        amount: '',
        date: '',
      ...
      toast.error('Erro ao salvar receita', { id: toastId });
    } finally {
      setLoading(false);
    }
  };
