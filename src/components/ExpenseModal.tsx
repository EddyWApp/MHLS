...
const ExpenseModal = ({ isOpen, onClose, onSuccess, categories, onCategoryAdded }: ExpenseModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const toastId = toast.loading('Salvando despesa...');
    ...
    try {
      ...
      toast.success('Despesa salva com sucesso!', { id: toastId });
      setFormData({
        name: '',
        amount: '',
        date: '',
      ...
      toast.error('Erro ao salvar despesa', { id: toastId });
    } finally {
      setLoading(false);
    }
  };
